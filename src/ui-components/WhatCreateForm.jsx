...
export default function WhatCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSmall_business(initialValues.small_business);
    setLarge_business(initialValues.large_business);
    setGovernment_agency(initialValues.government_agency);
    setNon_profit(initialValues.non_profit);
    setLender(initialValues.lender);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new What(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WhatCreateForm")}
      {...rest}
    >
      <SwitchField
